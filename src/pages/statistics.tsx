...
export default function Statistics(): JSX.Element {
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      if (
        statsInstance &&
        typeof statsInstance.stopUpdateInterval === "function"
      ) {
        ...
        <div className={styles.controls}>
          ...
          <div className={`webstats-status ${styles.statusBlock}`}>
            {initError ? (
              ...
              <>
                <span
                  className={`webstats-loading-indicator ${styles.loading}`}
                >
                  Загрузка данных...
                </span>
                <span
                  className={`webstats-error-message ${styles.error}`}
                ></span>
              </>
            )}
          </div>
